...
<div class="border:20px;"><span><div class ="circle topleft">
    <span class ="float-left pt-5  pl-5 mt-5"><span></span><h4 id="cqn"class="float-left pl-5"><?php echo $data['qno'];?></h4></span></div></span>
<span><h4 class="float-right " id="rank" ><a href="lb.php" target="_blank">#Rank</a></h4></span>
</div>
...
<div class="container">
  ...
  <div class="row  justify-content-center align-items-center d-flex text-center h-100">
          <div class="col-12 col-md-8  h-50 ">
              <h1 class="display-4 mt-4 pt-4   text-center mb-2 mt-5" id="cqt"><?php echo $data['qtext'];?> </h1>
              
            
              <div id = "image" <?php if($data['qtype']!="image")
              echo 'style = "display:none;"'?>>
                                        <img <?php if($data['qtype']=="image")
              echo 'src = "'.$data['qcontent'].'"'?> id="qimage" style = "height:300px; width:300px;">
                                    </div>
               <div id="audio"  <?php if($data['qtype']!="audio")
              echo 'style = "display:none;"'?>>
                                        <audio <?php if($data['qtype']=="audio")
              echo 'src = "'.$data['qcontent'].'"'?> id="qaudio"  controls>
...
<div id="preload"></div>
  ...
  <!--<div id="pbar" style="width:0%"class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100"></div>-->
    <div id="pbar" style="<?php $wd = 10*($data['qno']-1); echo 'width:'.$wd.'%;  color:#000; background-color:#fff;' ?>" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100"><?php echo 10-$data['qno'];?> left</div>
